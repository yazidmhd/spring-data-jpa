...
//this class was created automatically via @JoinTable annotation
//but since we are specifying a composite key
//we will need to create the enrolment class manually
//and embed the composite key into the enrolment class
